  ...
  return (
    <div className="space-y-6 max-w-lg">
      ...
      <div className="bg-bg-card border border-border-subtle rounded-xl p-6">
        ...
        <div onClick={copyLink} className="flex items-center gap-2 bg-bg-card2 border border-border-subtle rounded-xl p-3 cursor-pointer hover:border-cyan transition-colors">
      ...
      <div className="bg-bg-card border border-border-subtle rounded-xl p-6">
        ...
        <div className="flex flex-wrap gap-3">
          <button onClick={shareWhatsApp} className="btn-ghost px-4 py-2 text-sm">💬 WhatsApp</button>
          <button onClick={shareTelegram} className="btn-ghost px-4 py-2 text-sm">✈️ Telegram</button>
          <button onClick={copyLink} className="btn-ghost px-4 py-2 text-sm">📋 Copy Link</button>
        </div>
      </div>
    </div>
  )
